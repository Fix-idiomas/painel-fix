  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-100 to-slate-300 overflow-hidden">
      ...
      <img
        ...
        style={{ width: '80vw', maxWidth: 1200, minWidth: 600 }}
        aria-hidden="true"
      />
      <div className="bg-white shadow-xl rounded-2xl p-8 w-full max-w-md flex flex-col items-center relative z-10">
        <img
          src="/Logo Oficial.png"
          alt="Logo"
          className="w-84 h-64 mb-4 rounded-full shadow"
        />
        <h1 className="text-2xl font-bold mb-2 text-slate-800">Bem-vindo ao Painel Fix</h1>
